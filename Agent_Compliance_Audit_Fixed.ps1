...
<body>
    ...
    <script>
        // Dashboard data
        const dashboardData = $(DomainDataJson);
...
"@
    ...
    # Convert domain data to JSON
    $DomainDataJson = $DomainData | ConvertTo-Json -Depth 5
    
    # Replace placeholder with actual data
    $DashboardHtml = $DashboardHtml -replace '\$\(DomainDataJson\)', $DomainDataJson
