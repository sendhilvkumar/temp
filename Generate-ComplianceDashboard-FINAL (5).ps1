...
"@
        ...
        <tr data-domain="Patch Analysis" style="background-color: $($PatchFile.Color)10;">
            ...
            <td>$FileSize KB</td>
            <td>$LastModified</td>
            <td><a href="file:///$($PatchFile.FilePath.Replace('\', '/'))" class="download-link" target="_blank" style="background: $($PatchFile.Color); color: white; padding: 0.25rem 0.5rem; border-radius: 4px; text-decoration: none;">📥 Download</a></td>
        </tr>
"@
        }
