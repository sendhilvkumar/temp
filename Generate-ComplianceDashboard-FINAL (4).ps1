...
function Generate-PatchAnalysisCSVs {
    ...
    $CategoryInfo = @{
        "recent" = @{
            Name = "Recent Patches (0-90 days)"
            FileName = "patch-servers-recent-$Timestamp.csv"
            Color = "#28a745"
            Description = "Servers with patches installed in the last 90 days"
        }
        "moderate" = @{
            Name = "Moderate Patches (91-180 days)"
            FileName = "patch-servers-moderate-$Timestamp.csv"
            Color = "#ffc107"
            Description = "Servers with patches 3-6 months old"
        }
        "old" = @{
            Name = "Old Patches (181-365 days)"
            FileName = "patch-servers-old-$Timestamp.csv"
            Color = "#fd7e14"
            Description = "Servers with patches 6-12 months old"
        }
        "veryold" = @{
            Name = "Very Old Patches (365+ days)"
            FileName = "patch-servers-veryold-$Timestamp.csv"
            Color = "#dc3545"
            Description = "Servers with patches over 1 year old"
        }
        "unknown" = @{
            Name = "Unknown Patch Dates"
            FileName = "patch-servers-unknown-$Timestamp.csv"
            Color = "#6c757d"
            Description = "Servers with missing patch installation dates"
        }
    }
