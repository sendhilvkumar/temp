...
$outputFolder = ".\Report_$($startGroupName)_$timestamp"
    ...
    foreach ($groupDN in $groupsToQuery) {
        try {
            ...
            foreach ($member in $members) {
                ...
                # Note: Foreign Security Principals will appear as 'user' or 'group' with a different DN.
                # The script will attempt to query them, which may succeed or fail depending on cross-domain trusts and permissions.
            }
        }
        catch {
